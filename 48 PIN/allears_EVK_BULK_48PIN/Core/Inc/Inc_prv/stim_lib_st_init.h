...
#define STIM_LIB_PEAK_DETECTION_PWR_SW_PIN				GPIO_PIN_13
#define STIM_LIB_PEAK_DETECTION_PWR_SW_GPIO_PORT		GPIOB
...
#define STIM_LIB_LED_PIN								GPIO_PIN_3
#define STIM_LIB_LED_GPIO_PORT							GPIOH

...
#define PEAK_DETECTION_PWR_SW_Pin GPIO_PIN_13
#define PEAK_DETECTION_PWR_SW_GPIO_Port GPIOB
...
#define ST_USART_TX_Pin GPIO_PIN_9
#define ST_USART_TX_GPIO_Port GPIOA
#define ST_USART_RX_Pin GPIO_PIN_10
#define ST_USART_RX_GPIO_Port GPIOA
...
#define BTN_START_Pin GPIO_PIN_9
